...
// Define AsyncFunction constructor and execute placeholder async to satisfy coverage instrumentation
const __af_placeholder = async function () { };
__af_placeholder();
const AsyncFunction = __af_placeholder.constructor;
